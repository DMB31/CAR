...
function d(t, n) {
    ...
    for(let e = 1; e < i.length; e++){
        const t = o.match(/\[([^\]]+)\]/g)?.[e - 1].replace(/[[\]]/g, "");
        t && (s[t] = i[e]);
    }
    return s;
}
...
function o(o, a, l, s, t) {
    ...
    const { name: c, ...i } = s.localeCookie, r = resolveLocale_c(o.headers, t?.locales || s.locales, s.defaultLocale), n = o.cookies.has(c), f = n && o.cookies.get(c)?.value !== l;
    (n ? f : r !== l) && a.cookies.set(c, l, {
...
function v(v) {
    ...
    return function(t) {
        ...
        const j = utils_v(v), { domain: w, locale: k } = resolveLocale_f(L, t.headers, t.cookies, j), b = w ? w.defaultLocale === k : k === L.defaultLocale, R = L.domains?.filter((e)=>utils_x(k, e)) || [], q = null != L.domains && !w;
        function y(o) {
            const a = new URL(o, t.url);
            t.nextUrl.basePath && (a.pathname = utils_j(a.pathname, t.nextUrl.basePath));
            const l = new Headers(t.headers);
            return l.set(constants_L, k), NextResponse.rewrite(a, {
                request: {
                    headers: l
                }
            });
        ...
        function H(r, o) {
            ...
            if (l.pathname = utils_i(l.pathname), R.length > 0 && !o && w) {
                const e = m(w, k, R);
                e && (o = e.domain, e.defaultLocale === k && "as-needed" === L.localePrefix.mode && (l.pathname = utils_l(l.pathname, L.locales, L.localePrefix)));
            }
            if (o && (l.host = o, t.headers.get("x-forwarded-host"))) {
        ...
        if (B) {
            let e;
            if ([e, S] = s(B, z, k), S) {
                const r = B[S], a = u(r, k, S);
                if (utils_c(a, z)) V = utils_f(z, a, S);
                else {
                    let o;
                    o = e ? u(r, e, S) : S;
                    const s = I ? void 0 : utils_o(k, L.localePrefix), i = utils_f(z, o, a);
        ...
        if (!N) if ("/" !== V || C) {
            ...
            if (C) {
                ...
                if ("never" === L.localePrefix.mode) N = H(utils_p(z, void 0, t.nextUrl.search));
                    ...
                    const t = m(w, A.locale, R);
                    N = w?.domain === t?.domain || q ? y(e) : H(r, t?.domain);
                } else N = y(e);
                else N = H(r);
